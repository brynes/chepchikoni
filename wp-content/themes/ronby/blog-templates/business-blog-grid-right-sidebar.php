...
<?php 
   /* 
   * Template Name: Business Blog Grid Right Sidebar 
   */ 
   
   if(basename(get_page_template()) == "business-blog-grid-right-sidebar.php") { 
   get_header(); ?>
...
<?php } ?>
<!-- Content -->
<div id="content" class="p-125-0-110 blog-section blog-grid-wth-sidebar">
	<!-- pagiloader -->
                     ...
                     <article class="blog-post-item-1">					 
                        ...
                        <div class="thumbnail thumbnail-rounded animate-zoom">
                           <a href="<?php esc_url(the_permalink())?>">
                              <div class="blog-p-f-img" style="background-image: url(<?php echo esc_url($get_image)?>); background-position: center;background-size:cover"></div>
                           </a>
                           <?php 
