...
<?php 
   /* 
   * Template Name: Medical Blog With Right Sidebar
   */ 
   
   if(basename(get_page_template()) == "medical-blog.php") { 
   get_header(); ?>
...
<?php } ?>
<!-- Content -->
<div id="content" class="p-120-0 blog-section blog-grid-wth-sidebar">
	<!-- pagiloader -->
               ...
               <div class="row">
				 ...
				 <!-- Start Blog post  --> 	 
                  <div  <?php post_class('col-md-6'); ?> id="post-<?php the_ID(); ?>">
                     <article class="blog-post-item-5">					 
                        <?php
                        ...
                        <div class="thumbnail thumbnail-rounded animate-zoom">
                           <a href="<?php esc_url(the_permalink())?>">
                              <div class="blog-p-f-img h-246 h-351" style="background-image: url(<?php echo esc_url($get_image)?>); background-position: center;background-size:cover"></div>
                           </a>
