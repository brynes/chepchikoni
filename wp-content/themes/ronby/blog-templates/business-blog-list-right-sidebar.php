...
<?php 
   /* 
   *Template Name: Business Blog List With Right Sidebar
   */ 
     
   // Blog Template start 
   if(basename(get_page_template()) == "business-blog-list-right-sidebar.php") { 
   get_header(); ?>
      ...
      <div class="container">
         <div class="row">	
                     ...
                     <div class="bg2-featurebox-3">
                        ...
                        <div class="img-box thumbnail thumbnail-rounded animate-zoom">
                           <a href="<?php esc_url(the_permalink())?>">
                              <div class="blog-p-f-img h-330" style="background-image: url(<?php echo esc_url($get_image)?>); background-position: bottom;background-size: auto; background-repeat: no-repeat;"></div>
                           </a>
                           <!-- Start Blog post info box -->
						   <?php if( ((ronby_get_option('ronby_blog_page_post_author_meta_switch') == 1) &&
									(function_exists('business_list_author_meta'))) ||
									((ronby_get_option('ronby_blog_page_post_date_meta_switch') == 1) &&
									((function_exists('business_list_wp_date_meta')) ||
									(function_exists('business_list_theme_date_meta')))) ){ ?>
                           <div class="postdate-box">
                              <div class="blog-post-info">    
                                 ...
                                 <?php } //check if post date meta switch is turned on 
                        ...
                        <div class="postinfo-box">
                           <?php
								if ( is_sticky() && is_home() ) {
									printf( '<span class="post-featured">%s</span>', esc_html_x( 'Featured Post', 'post', 'ronby' ) );
									echo '<div class="mh-20"></div>';
								}
							?>
            ...
            <!-- /Main content -->
		 	<!-- Start sidebar  -->  					 
			<div class="col-lg-4">
			<div id="right-sidebar" class="sidebar side-bar">
				<?php get_sidebar();?>
			</div>
			</div>	
			<!-- End sidebar  --> 			
...
<?php if(function_exists('ronby_pagination_without_loading')){
               ...
               <div class="row">
                  ...
                  <div  <?php post_class('col-md-12'); ?> id="post-<?php the_ID(); ?>">
                     <div class="bg2-featurebox-3">
                        ...
                        <div class="img-box thumbnail thumbnail-rounded animate-zoom">
                           <a href="<?php esc_url(the_permalink())?>">
								<img class="cntr_auto" src="<?php echo esc_url($get_image)?>" alt="<?php esc_attr_e('Featured Image', 'ronby')?>" />
                           </a>
                           <!-- Start Blog post info box -->  
							<?php if( ((ronby_get_option('ronby_blog_page_post_author_meta_switch') == 1) &&
									(function_exists('business_list_author_meta'))) ||
                           ...
                           <div class="postdate-box">
                              <div class="blog-post-info">    
                                 ...
                                 <?php
                                    ...
                                    if(ronby_get_option('ronby_blog_page_post_date_wordpress_switch') == 1){ ?>
                                 <?php if(function_exists('business_list_wp_date_meta')) business_list_wp_date_meta(); ?>
                                 <?php } else { // end wordpress format post date meta ?>    
                                 <?php if(function_exists('business_list_theme_date_meta')) business_list_theme_date_meta(); ?>        
                                 <?php }
									} // end post date meta
                                  ?>
