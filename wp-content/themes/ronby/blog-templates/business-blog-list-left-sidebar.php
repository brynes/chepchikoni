...
<?php 
   /* 
   *Template Name: Business Blog List With Left Sidebar
   */ 
     
   // Blog Template start 
   if(basename(get_page_template()) == "business-blog-list-left-sidebar.php") { 
   get_header(); ?>
                     ...
                     <div class="bg2-featurebox-3">
                        ...
                        <div class="img-box thumbnail thumbnail-rounded animate-zoom">
                           <a href="<?php esc_url(the_permalink())?>">
                              <div class="blog-p-f-img h-366" style="background-image: url(<?php echo esc_url($get_image)?>); background-position: center;background-size:cover"></div>
                           </a>
