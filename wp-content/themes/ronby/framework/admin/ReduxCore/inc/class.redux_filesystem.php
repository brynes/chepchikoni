        ...
        class Redux_Filesystem {
            ...
            public function ftp_form() {
                if ( isset( $this->parent->ftp_form ) && ! empty( $this->parent->ftp_form ) ) {
                    ...
                    echo '<strong>' . esc_attr__( 'File Permission Issues', 'ronby' ) . '</strong><br/>' . sprintf( esc_attr__( 'We were unable to modify required files. Please ensure that <code>%1s</code> has the proper read-write permissions, or modify your wp-config.php file to contain your FTP login credentials as <a href="%2s" target="_blank">outlined here</a>.', 'ronby' ), Redux_Helpers::cleanFilePath( trailingslashit( WP_CONTENT_DIR ) ) . '/uploads/', '' );
            ...
            public function do_action( $action, $file = '', $params = '' ) {
                ...
                if ( ! $res ) {
                    ...
                    $msg = '<strong>' . esc_attr__( 'File Permission Issues', 'ronby' ) . '</strong><br/>' . sprintf( esc_attr__( 'We were unable to modify required files. Please ensure that <code>%1s</code> has the proper read-write permissions, or modify your wp-config.php file to contain your FTP login credentials as <a href="%2s" target="_blank">outlined here</a>.', 'ronby' ), Redux_Helpers::cleanFilePath( trailingslashit( WP_CONTENT_DIR ) ) . '/uploads/', '' );
