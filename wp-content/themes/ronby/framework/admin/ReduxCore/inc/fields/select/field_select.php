    ...
    class ReduxFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_attr__( 'Select an item', 'ronby' );
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'ronby' ) . '</strong>';
            }
        } //function
