        ...
        public function render() {
            ...
            if ( ! empty( $this->value ) ) {
                ...
                foreach ( $ids as $attachment_id ) {
                    ...
                    echo '<img class="redux-option-image" id="image_' . $this->field['id'] . '_' . $attachment_id . '" src="' . $img[0] . '" alt="gallery-image" target="_blank" rel="external" />';
                    echo '</a>';
                }
            }

            echo '</div>';
            echo '<a href="#" onclick="return false;" id="edit-gallery" class="gallery-attachments button button-primary">' . esc_html__( 'Add/Edit Gallery', 'ronby' ) . '</a> ';
            echo '<a href="#" onclick="return false;" id="clear-gallery" class="gallery-attachments button">' . esc_attr__( 'Clear Gallery', 'ronby' ) . '</a>';
