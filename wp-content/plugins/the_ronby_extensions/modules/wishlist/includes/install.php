...
if ( !class_exists( 'RONBY_WC_Compare_Wishlist_Install' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class RONBY_WC_Compare_Wishlist_Install {

		/**
		 * Single instance of the class
		 *
		 * @var \RONBY_WC_Compare_Wishlist_Install
		 * @since 2.0.0
		 */
		 ...
		 *
		 * @return \RONBY_WC_Compare_Wishlist_Install
		 * @since 2.0.0
		 */
		...
		public function init() {
			...
			$this->options = ronby_woowishlist_get_settings();
		...
		private function _add_pages() {
			...
			$this->_add_page( 'compare', __( 'Compare', 'ronby' ) );
			$this->_add_page( 'wishlist', __( 'Wishlist', 'ronby' ) );
		}
...
/**
 * Unique access to instance of RONBY_WC_Compare_Wishlist_Install class
 *
 * @return \RONBY_WC_Compare_Wishlist_Install
 * @since 2.0.0
 */
function RONBY_WC_Compare_Wishlist_Install(){
	return RONBY_WC_Compare_Wishlist_Install::get_instance();
}